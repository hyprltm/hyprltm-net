...
echo -e "  1. Remove keybind from Hyprland config${NC}:"
echo -e "     ${RED}# hyprlang (~/.config/hypr/hyprland.conf):${NC}"
echo -e "     ${RED}bind = SUPER, N, exec, hyprltm-net${NC}"
echo -e "     ${RED}# Lua (~/.config/hypr/hyprland.lua):${NC}"
echo -e "     ${RED}hl.bind(\"SUPER + N\", hl.dsp.exec_cmd(\"hyprltm-net\"))${NC}"
echo ""
