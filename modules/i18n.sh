...
tr_checking_radio_states='Checking radio states...'
...
tr_dns_config_message='DNS Configuration'
...
tr_hotspot_starting='Starting Hotspot...'
tr_hotspot_stopping='Stopping Hotspot...'
...
tr_success='Success'
tr_error='Error'
tr_password_actions='Password Actions'
tr_connection_failed='Connection Failed'

# Status menu
tr_active_connection_details='Active Connection Details'
tr_all_device_status='All Device Status'
...
tr_mobile_label='Cellular (WWAN)'
tr_no_modem='No Modem'
tr_no_adapter='No Adapter'
tr_vpn_short='VPN'
tr_saved_connections='Saved Connections'
tr_status_short='Status'

# Connection profile
tr_disconnecting='Disconnecting...'
tr_disconnected_body='Disconnected from'
tr_connection_renamed='Connection renamed.'
tr_failed_rename='Failed to rename connection.'
tr_failed_disconnect='Failed to disconnect.'
tr_mac_randomization='MAC Randomization'
tr_mac_disabled='MAC Randomization Disabled'
tr_mac_enabled='MAC Randomization Enabled'

# Hotspot
tr_create_hotspot='Create New Hotspot'
tr_manage_saved_hotspots='Manage Saved Hotspots'
tr_delete_hotspot_profile='Delete Hotspot Profile'
tr_stop_hotspot='Stop Hotspot'
tr_enable_hotspot='Enable Hotspot'
tr_hotspot_started='Hotspot Started'
tr_hotspot_active='Active:'
tr_failed_start_hotspot='Failed to start hotspot.'
tr_hotspot_profile_deleted='Hotspot profile deleted.'
tr_disconnecting_wifi='Disconnecting Wi-Fi...'
tr_hotspot_created='Hotspot Created'

# Wired
tr_connect_wired='Connect to Wired Connection'

# IP config prompts
tr_enter_ip='Enter IP Address (e.g.'
tr_enter_gateway='Enter Gateway (Optional, e.g.'
tr_enter_dns='Enter DNS Server (Optional, e.g.'
tr_enter_dns_simple='Enter DNS Server (e.g.'

# QR
tr_scan_to_connect='Scan to Connect'
...
# Airplane mode
tr_enable_wifi='Enable Wi-Fi'
tr_disable_wifi_only='Disable Wi-Fi Only'
tr_full_airplane='Full Airplane Mode'
tr_airplane_options='Airplane Mode Options'
tr_disabling_radios='Disabling all radios...'
tr_enabling_radios='Enabling all radios...'
tr_disabling_wifi='Disabling Wi-Fi...'
tr_enabling_wifi='Enabling Wi-Fi...'
tr_wifi_turned_off='Wi-Fi Turned Off'
tr_wifi_turned_on='Wi-Fi Turned On'

# BT Tether
tr_bt_is_off='Bluetooth is off'
tr_cancel='Cancel'
tr_manage='Manage'

# Connection messages
tr_cancelled_no_password='Connection cancelled. No password provided.'
tr_already_connected='Already connected to'
tr_invalid_option='Invalid option selected:'

# Password hint
tr_password_min_length='Password must be at least 8 characters.'

# Startup errors (sourced before core)
tr_startup_no_rofi='Error: rofi is not installed. Please install it to use this script.'
tr_startup_no_nmcli='Error: nmcli is not installed. Please install NetworkManager and nmcli.'
tr_startup_bad_theme='Warning: ROFI_NETWORK_MANAGER_THEME'
tr_warn_missing_rasi='Warning: ltmnight.rasi not found next to'
tr_warn_missing_rasi_colors='. Colors may not render correctly.'

# Connection error details
tr_clean_incorrect_pwd='Incorrect password or missing credentials.'
tr_clean_network_not_found='Network not found. It may be out of range.'
tr_clean_refused='Connection failed. The network refused the connection.'
tr_clean_timeout='Connection timed out. The network is too slow or unreachable.'
tr_clean_cancelled='Operation cancelled.'

tr_gathering_details='Gathering details...'
tr_bt_power_failed='Failed to power on Bluetooth'

tr_warn_no_notification='No Notification Service Found'
tr_warn_no_notification_desc='You can continue, but you won'\''t receive desktop notifications.'
tr_saved_hotspots_title='Saved Hotspots'
tr_no_saved_hotspots='No saved hotspot profiles found.'
tr_hotspot_no_dnsmasq="Missing dependency: 'dnsmasq'\nRequired to assign IP addresses (DHCP) to connected devices.\nPlease install it: sudo pacman -S dnsmasq (or equivalent)"
tr_btctl_not_found='bluetoothctl not found'
tr_no_connection_profile='Could not find connection profile for'
tr_no_saved_wired='No saved wired connections to connect to.'
tr_wifi_disconnect_title='Wi-Fi Disconnect Required'
tr_hotspot_will_disconnect="Starting Hotspot will disconnect current Wi-Fi.\nProceed?"
tr_hotspot_disconnect_msg="Starting a Hotspot will disconnect you from the current Wi-Fi network.\nYour card cannot do both simultaneously."

tr_bt_tether_menu='Connect to Bluetooth Tether'
tr_bt_scanning='Scanning for Bluetooth devices...'
tr_bt_no_devices='No Bluetooth devices found.'
tr_bt_no_adapter='No Bluetooth adapter found.'
tr_bt_power_on='Power on Bluetooth'
tr_bt_powering='Powering on Bluetooth...'
tr_bt_creating_profile='Creating Bluetooth tether profile...'
tr_bt_profile_created='Bluetooth tether profile created'
tr_bt_create_failed='Failed to create Bluetooth tether profile'
tr_bt_connect='Connect'
tr_bt_pair_connect='Pair & Connect'
tr_bt_rescan='Rescan'
tr_bt_pairing='Pairing...'
tr_bt_pair_failed='Pairing failed'
tr_bt_connecting='Connecting...'
tr_bt_select_device='Select device:'
...
_bt_lang="${LANG:0:2}"
_bt_i18n_dir="$(dirname "${BASH_SOURCE[0]}")/i18n"
if [ -f "$_bt_i18n_dir/$_bt_lang.sh" ]; then
    source "$_bt_i18n_dir/$_bt_lang.sh"
fi
unset _bt_lang _bt_i18n_dir
